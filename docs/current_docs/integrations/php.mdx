...
<TabItem value="PHP">
:::note
The PHP SDK is experimental and under active development, so documentation is currently sparse.
Interested early adopters can learn more by [reviewing the README generated with every module](https://github.com/dagger/dagger/tree/main/sdk/php/runtime/template/README.md) or visiting our [PHP channel](https://discord.com/channels/707636530424053791/1162025276872609832).
:::

Bootstrap a new module:

```shell
dagger init --name=my-module --sdk=php --source=./dagger
```

Update the generated `dagger/src/MyModule.php` file with the following code:

```php file=./snippets/php/php/MyModule.php
```
